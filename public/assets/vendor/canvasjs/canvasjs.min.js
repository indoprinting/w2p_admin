...
this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=l._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new H(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=
...
this.data[d],a.dataPoints&&(0!==a.dataPoints.length&&a.visible)&&0<=l._supportedChartTypes.indexOf(a.type)){for(var c=null,b=!1,e=null,f=!1,p=0;p<this.plotInfo.plotTypes.length;p++)if(this.plotInfo.plotTypes[p].type===a.type){b=!0;c=this.plotInfo.plotTypes[p];break}b||(c={type:a.type,totalDataSeries:0,plotUnits:[]},this.plotInfo.plotTypes.push(c));for(p=0;p<c.plotUnits.length;p++)if(c.plotUnits[p].axisYType===a.axisYType&&c.plotUnits[p].axisXType===a.axisXType&&c.plotUnits[p].axisYIndex===a.axisYIndex&&
...
(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==t.dataPoints[B-1].y&&(a.axisY.logarithmic?(r=e/t.dataPoints[B-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-t.dataPoints[B-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(n=b);else{if(!k&&(k=!0,0<B)){B-=2;continue}if(b>h&&!m)m=!0;else if(b>h&&m)continue;t.dataPoints[B].label&&(a.axisX.labels[b]=t.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===
...
x)}else x=b-n.dataPoints[q-1].x,0>x&&(x*=-1),c.minDiff>x&&0!==x&&(c.minDiff=x);null!==e&&null!==n.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(x=e/n.dataPoints[q-1].y,1>x&&(x=1/x),d.minDiff>x&&1!==x&&(d.minDiff=x)):(x=e-n.dataPoints[q-1].y,0>x&&(x*=-1),d.minDiff>x&&0!==x&&(d.minDiff=x)))}if(b<l&&!h)null!==n.dataPoints[q].y&&(g=b);else{if(!h&&(h=!0,0<q)){q-=2;continue}if(b>u&&!r)r=!0;else if(b>u&&r)continue;n.dataPoints[q].label&&(a.axisX.labels[b]=n.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=
...
0;n<m.dataPoints.length;n++){"undefined"===typeof m.dataPoints[n].x&&(m.dataPoints[n].x=n+(a.axisX.logarithmic?1:0));m.dataPoints[n].x.getTime?(f=!0,b=m.dataPoints[n].x.getTime()):b=m.dataPoints[n].x;e=s(m.dataPoints[n].y)?null:m.dataPoints[n].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<n){if(a.axisX.logarithmic){var u=b/m.dataPoints[n-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-m.dataPoints[n-1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);s(e)||null===m.dataPoints[n-1].y||
(a.axisY.logarithmic?0<e&&(u=e/m.dataPoints[n-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-m.dataPoints[n-1].y,0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u)))}if(b<g&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<n)){n-=2;continue}if(b>l&&!h)h=!0;else if(b>l&&h)continue;m.dataPoints[n].label&&(a.axisX.labels[b]=m.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:
0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?p=!0:0>e&&(t=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}m.axisX.valueType=m.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):p&&!t?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,99),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):p&&
...
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(k.dataPoints[m].x&&k.dataPoints[m].x.getTime||"dateTime"===k.xValueType)t=!0;for(m=0;m<k.dataPoints.length;m++){"undefined"===typeof k.dataPoints[m].x&&(k.dataPoints[m].x=m+(a.axisX.logarithmic?1:0));k.dataPoints[m].x.getTime?(t=!0,b=k.dataPoints[m].x.getTime()):b=k.dataPoints[m].x;if((e=k.dataPoints[m].y)&&e.length){f=Math.min.apply(null,e);p=Math.max.apply(null,e);r=!0;for(var x=
0;x<e.length;x++)null===e.k&&(r=!1);r&&(n||(g=h),h=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);p>d.max&&(d.max=p);0<m&&(a.axisX.logarithmic?(r=b/k.dataPoints[m-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[m-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[m-1].y&&null!==k.dataPoints[m-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/k.dataPoints[m-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[m-1].y[0],
...
(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=t.dataPointEOs[B].cumulativeSum-t.dataPointEOs[B-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<B)){B-=2;continue}if(b>h&&!m)m=!0;else if(b>h&&m)continue;t.dataPoints[B].label&&(a.axisX.labels[b]=t.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<B&&(t.dataPointEOs[B-1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=t.dataPointEOs[B-1].cumulativeSum),t.dataPointEOs[B-
...
h,k=0,p=0;p<a.dataSeriesIndexes.length;p++){var m=e.data[a.dataSeriesIndexes[p]];if(!(4>m.dataPoints.length))for(k=0;k<m.dataPoints.length;k++)h=(d+1-c)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,b=m.dataPoints[k].x.getTime?m.dataPoints[k].x.getTime():m.dataPoints[k].x,h=Math.floor((b-c)/h),b<f[h].min&&(f[h].min=b),b>f[h].max&&(f[h].max=b)}}for(var b,e=this,f=!1,p=0;p<this._axes.length;p++)if(this._axes[p].scaleBreaks&&this._axes[p].scaleBreaks.autoCalculate&&1<=this._axes[p].scaleBreaks.maxNumberOfAutoBreaks){f=
...
m,n,f=[];if(this._axes[p].dataInfo.dataPointYPositiveSums){var q=this._axes[p].dataInfo.dataPointYPositiveSums;m=k;for(t in q)if(q.hasOwnProperty(t)&&!isNaN(t)&&(n=q[t],!s(n))){var h=Math.floor((n-B)/b);n<m[h].min&&(m[h].min=n);n>m[h].max&&(m[h].max=n)}delete this._axes[p].dataInfo.dataPointYPositiveSums}if(this._axes[p].dataInfo.dataPointYNegativeSums){q=this._axes[p].dataInfo.dataPointYNegativeSums;m=k;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(n=-1*q[t],s(n)||(h=Math.floor((n-B)/b),n<m[h].min&&
(m[h].min=n),n>m[h].max&&(m[h].max=n)));delete this._axes[p].dataInfo.dataPointYNegativeSums}for(t=0;t<k.length-1;t++)if(m=k[t].max,isFinite(m))for(;t<k.length-1;)if(B=k[t+1].min,isFinite(B)){n=B-m;n>b&&f.push({diff:n,start:m,end:B});break}else t++;if(this._axes[p].scaleBreaks.customBreaks)for(t=0;t<this._axes[p].scaleBreaks.customBreaks.length;t++)for(b=0;b<f.length;b++)if(this._axes[p].scaleBreaks.customBreaks[t].startValue<=f[b].start&&f[b].start<=this._axes[p].scaleBreaks.customBreaks[t].endValue||
...
(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};l.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(w)b=Ya(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};l.prototype.getAutoFontSize=lb;l.prototype.resetOverlayedCanvas=function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return l}();y.version="v3.4.6 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
