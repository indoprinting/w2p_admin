...
<div class="form-group row">
    <label for="name" class="col-4 col-form-label">Minimal Order
        <x-important />
    </label>
    <div class="col-8">
        <x-input type="text" name="min_order" value="{{ old('min_order') ?? 1 }}" required />
    </div>
</div>
<div class="form-group row">
    <label for="name" class="col-4 col-form-label">Minimal Isi (khusus Buku)
        <x-important />
    </label>
    <div class="col-8">
        <x-input type="text" name="min_isi" value="{{ old('min_isi') ?? 3 }}" required />
    </div>
</div>
<div class="form-group row">
