            ...
            <div class="card-body text-sm">
                ...
                <form style="display: flex;align-items: center;" class="mb-2 w-50 float-right">
                    <x-select name="type" style="margin-right: 5px;width: 25%">
                        ...
                        <option value="idp_orders.cust_name" @if (request()->type == 'idp_orders.cust_name') selected @endif>Nama</option>
                    </x-select>
                    ...
                    <tbody>
                        @foreach ($orders as $i => $order)
                            <tr class="{{ $order->proced == 0 ? 'text-danger text-bold' : '' }}">
                                ...
                                <td>
                                    <a href="{{ route('order.detail', $order->id_order) }}" target="_blank">{{ $order->invoice }}</a>
                                </td>
                                <td width="10%">
